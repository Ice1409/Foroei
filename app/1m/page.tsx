...
export default function Home() {
  ...
  // Sample images for the memories gallery
    const memoryImages = [
        "/1mpicture/Oei (1).jpg?height=200&width=200",
        "/1mpicture/Oei (2).jpg?height=200&width=200",
        "/1mpicture/Oei (3).jpg?height=200&width=200",
        "/1mpicture/Oei (4).jpg?height=200&width=200",
        "/1mpicture/Oei (5).jpg?height=200&width=200",
        "/1mpicture/Oei (6).jpg?height=200&width=200",
        "/1mpicture/Oei (7).jpg?height=200&width=200",
        "/1mpicture/Oei (8).jpg?height=200&width=200",
        "/1mpicture/Oei (9).jpg?height=200&width=200",
        "/1mpicture/Oei (10).jpg?height=200&width=200",
        "/1mpicture/Oei (11).jpg?height=200&width=200",
        "/1mpicture/Oei (12).jpg?height=200&width=200",
        "/1mpicture/Oei (13).jpg?height=200&width=200",
        "/1mpicture/Oei (14).jpg?height=200&width=200",
        "/1mpicture/Oei (15).jpg?height=200&width=200",
        "/1mpicture/Oei (16).jpg?height=200&width=200",
        "/1mpicture/Oei (17).jpg?height=200&width=200",
        "/1mpicture/Oei (18).jpg?height=200&width=200",
      ]
      ...
      <div className="relative mb-12 animate-[fadeIn_1.5s_ease-in] mt-6">
        <div className={`absolute -top-10 -left-10 rotate-[-10deg] z-10 ${floatingAnimationSlow}`}>
          <div className="w-16 h-20 bg-white rounded-md shadow-md overflow-hidden">
            <Image
              src="/1mpicture/Oei (1).jpg?height=80&width=64"
              alt="Decoration"
              width={64}
              height={80}
        ...
        <div className={`absolute -top-5 -right-10 rotate-[10deg] z-10 ${floatingAnimation}`}>
          <div className="w-16 h-20 bg-white rounded-md shadow-md overflow-hidden">
          <Image
              src="/1mpicture/top2.jpg?height=80&width=64"
              alt="Decoration"
              width={64}
              height={80}
              className="object-cover"
        ...
        <div className={`absolute -bottom-5 -right-5 rotate-[5deg] z-10 ${floatingAnimationFast}`}>
          ...
          <Image
              src="/1mpicture/Oei (2).jpg?height=80&width=64"
              alt="Decoration"
              width={64}
              height={80}
              className="object-cover"
        ...
        <div className="w-64 h-64 md:w-80 md:h-80 rounded-3xl overflow-hidden shadow-lg">
          <Image
            src="/1mpicture/ku.jpg?height=320&width=320"
            alt="Birthday Person"
            width={320}
            height={320}
